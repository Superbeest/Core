...
<xsl:template match="//forms/form">
    <form>
        ...
        <xsl:if test="accept-charset != ''"><xsl:attribute name="accept-charset"><xsl:value-of select="accept-charset" /></xsl:attribute></xsl:if>
        ...
        <xsl:if test="novalidate != ''"><xsl:attribute name="novalidate">novalidate</xsl:attribute></xsl:if>
        ...
        <xsl:if test="events/onreset != ''"><xsl:attribute name="onreset"><xsl:value-of select="events/onreset" disable-output-escaping="yes" /></xsl:attribute></xsl:if>
        <xsl:if test="events/onsubmit != ''"><xsl:attribute name="onsubmit"><xsl:value-of select="events/onsubmit" disable-output-escaping="yes" /></xsl:attribute></xsl:if>
    ...
    <xsl:if test="init != ''">
        <script type="text/javascript">
            <xsl:value-of select="init" disable-output-escaping="yes" />
        </script>
    </xsl:if>
</xsl:template>
