...
/**
* Implements the InputDateTimeLocal element
* @package \Module\HTMLForm\Element
*/
class InputDateTimeLocal extends \Module\HTMLForm\Element\InputNumber
{
	/**
	...
	*/
    ...
    {
    	$xml->addAttribute('type', 'datetime-local');
	}
}