...
/**
* Implements a container for HTMLElements
* @package \Module\HTMLForm\Element
*/
class ElementContainer extends \Module\HTMLForm\HTMLElement
{
    /**
    * @publicget
    * @publicset
    ...
    */
    ...
    /**
    * Returns the Id of its child.
    * @return int The id of the child
    */
    ...
    */
    ...
    {
        $child = $xml->addChild('elementcontainer');
