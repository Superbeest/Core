...
/**
* Implements the InputDateTime element
* @package \Module\HTMLForm\Element
*/
class InputDateTime extends \Module\HTMLForm\Element\InputNumber
{
	/**
	...
	*/
    ...
    {
    	$xml->addAttribute('type', 'datetime');
	}
}