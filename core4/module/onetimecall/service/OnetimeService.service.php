...
namespace Module\Onetimecall\Service;
...
/**
* The service which is used to check the onetimecall credentials
* @package \Module\Onetimecall
*/
class OnetimeService extends \System\Web\Service
{
