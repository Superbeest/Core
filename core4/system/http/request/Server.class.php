...
class Server extends \System\Collection\BaseMap
{
    ...
    */
    ...
    {
        return \System\Security\Sanitize::sanitizeString($_SERVER);
    }
    ...
    */
    ...
    {
        $value = $this->keyExists($offset) ? \System\Security\Sanitize::sanitizeString($_SERVER[$offset]) : null;
