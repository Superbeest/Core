...
/**
* Outputs the renderer to a file
* @package \System\Output
*/
class FileSurface extends \System\Output\RenderSurface
{
    private $filename = '';
    ...
    */
    protected final function outputHeaders(\System\Output\Renderer $renderer)
    {
        //we don't want to output any headers
    }
}
